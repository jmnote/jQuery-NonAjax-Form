...
var s=$.extend({},d,o);var form=$('<form>').attr({method:s.method,target:s.target,data:s.data,action:s.action,}).css({display:'none'});var addData=function(name,data){if($.isArray(data)){for(var i=0;i<data.length;i++){addData(name+'[]',data[i]);}
return;}
